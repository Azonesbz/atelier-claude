...
export default function Page() {
  ...
  return (
    <main>
      ...
      <p className="mb-6 max-w-prose text-sm text-muted">Les plugins qui apportent du contenu, les hooks qui se déclenchent, les permissions qui autorisent, et les instructions chargées à chaque session.</p>
